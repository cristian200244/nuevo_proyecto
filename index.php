...
<body>
    ...
    <div class="container">
        ...
        <form action="../../models/registroModel.php" method="POST">
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-warning "><a href="index.php">Guardar</a> </button>
            <button type="submit" class="btn btn-warning "><a href="views/dashboard.php">Informacion</a> </button>
        </form>
